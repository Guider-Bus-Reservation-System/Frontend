...
const Reservations = () => {
  ...
  function handleBusNumberChange(event) {
    ...
    const selectedBus = busses.find((bus) => bus.id === parseInt(event.target.value));
      ...
      <div className="reservations">
        <div className="reservations-header">
          ...
          <div className="reservations-header-image-container">
            <img src="homepage.png" alt="homepage" className="reservations-header-image" />
          </div>
          ...
          <div className="reservations-bus-form-container">
            <form className="reservations-bus-form">
              <div className="reservations-form-group">
                <label htmlFor="reservations-bus-number">Select Bus Number:</label>
                <select
              ...
              <div className="reservations-form-group">
                <label htmlFor="reservations-passengers-count">Passengers Count:</label>
                <input
                  type="number"
              ...
              <div className="reservations-form-group">
                <label htmlFor="reservations-time-slot">Time Slot:</label>
                <select
